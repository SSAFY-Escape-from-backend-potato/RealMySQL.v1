...
- **n-gram 알고리즘**
    ...
    **형태소 분석이 문장을 이해하는 알고리즘이라면, n-gram은 단순히 키워드를 검색해내기 위한 인덱싱 알고리즘이다.**
    ...
    ![image.png](attachment:faf124e1-d6ad-4f26-85c8-9efba9732784:image.png)
    
    ![image.png](attachment:bc73da89-f995-45fc-a5b4-087f2c2e7aed:image.png)
...
![image.png](attachment:4704e7c9-cf3d-4751-a8bc-3dfff836a449:image.png)
